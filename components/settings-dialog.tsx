...
export default function SettingsDialog({ isOpen, onClose }: SettingsDialogProps) {
  ...
  const providers = [
    ...
    },
    {
      id: "vidlux",
      name: "VidLux",
      url: "https://vidlux.xyz/",
      description: "Multi-server provider 🔥",
      hasServers: true,
      servers: [
        { id: "vidlux.xyz", name: "vidlux.xyz" },
        { id: "vidlux.top", name: "vidlux.top" },
        { id: "vidlux.site", name: "vidlux.site" },
        { id: "vidlux.online", name: "vidlux.online" },
      ],
    },
    {
      id: "vidrush",
      name: "VidRush",
      url: "https://player.vidrush.net/",
      description: "High quality player 🥇",
    },
    {
      id: "vidking",
      name: "VidKing",
